 ...
 * @author nmartinez
 */
public class V_Formulari_Afegir extends javax.swing.JDialog {
    ...
    public V_Formulari_Afegir(java.awt.Frame parent, boolean modal,C_Formulari_Principal cfp) {
        super(parent, modal);
        try {
            this.cfp = cfp;
            initComponents();
            ...
            Logger.getLogger(V_Formulari_Afegir.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void FieldCodiFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_FieldCodiFocusLost
        FieldCodi.setBackground(new Color(44,62,80));
        String t = FieldCodi.getText();
        boolean encontrado = false;
        boolean v = U_Validadors.validarInt(t);
        if(t.equals("")){
            ErrorLabelCodi.setText("No hi ha codi.");
            FieldCodi.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, new Color(255, 57, 57)));
        } else if (!v){
            ErrorLabelCodi.setText("El codi no es un numero");
            FieldCodi.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, new Color(255, 57, 57)));
        } 
        else {
            ErrorLabelCodi.setText("");
            FieldCodi.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.white));
            try {
                encontrado = P_VaixellDAO.codiRepetit(Integer.parseInt(t));
            } catch (SQLException ex) {
                Logger.getLogger(V_Formulari_Afegir.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (encontrado) {
               ErrorLabelCodi.setText("El codi esta repetit"); 
               FieldCodi.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, new Color(255, 57, 57)));
            }
        }
        comprobarTot();
    ...
    private void comprobarTot(){
        try {
            if(!FieldCodi.getText().isEmpty() && U_Validadors.validarInt(FieldCodi.getText())
                    && !P_VaixellDAO.codiRepetit(Integer.parseInt(FieldCodi.getText())) && !FieldNom.getText().isEmpty() && !FieldRating.getText().isEmpty()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_Formulari_Afegir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                V_Formulari_Afegir dialog = new V_Formulari_Afegir(new javax.swing.JFrame(), true,null);
